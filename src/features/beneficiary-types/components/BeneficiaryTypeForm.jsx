...
import { useBeneficiaryTypeForm } from "../hooks/use-beneficiary-type-form";
...
export function BeneficiaryTypeForm({ defaultValues: item, onSuccess }) {
  const { form, formConfig, isPending, onSubmit } = useBeneficiaryTypeForm({ defaultValues: item, onSuccess });
