...
/**
 * Hook para gestionar filtros, paginación y ordenamiento de Roles sincronizados con la URL.
 */
export function useRoleTableFilters(pagination) {
  const router = useRouter();
  const searchParams = useSearchParams();
  const [isPending, startTransition] = useTransition();

  // Estado local para el input de búsqueda para evitar lag
