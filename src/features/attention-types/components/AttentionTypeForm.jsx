...
import { useAttentionTypeForm } from "../hooks/use-attention-type-form";
...
export function AttentionTypeForm({ defaultValues: item, onSuccess }) {
  const { form, formConfig, isPending, onSubmit } = useAttentionTypeForm({ defaultValues: item, onSuccess });
