...
import { useAttentionTypeDetailForm } from "../hooks/use-attention-type-detail-form";
...
export function AttentionTypeDetailForm({ defaultValues: item, onSuccess }) {
  const { form, formConfig, isPending, onSubmit } = useAttentionTypeDetailForm({ defaultValues: item, onSuccess });
