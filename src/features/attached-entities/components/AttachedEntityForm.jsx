...
import { useAttachedEntityForm } from "../hooks/use-attached-entity-form";
...
export function AttachedEntityForm({ defaultValues: item, onSuccess }) {
  const { form, formConfig, isPending, onSubmit } = useAttachedEntityForm({ defaultValues: item, onSuccess });
