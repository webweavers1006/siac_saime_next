...
import { useAttentionChannelForm } from "../hooks/use-attention-channel-form";
...
export function AttentionChannelForm({ defaultValues: item, onSuccess }) {
  const { form, formConfig, isPending, onSubmit } = useAttentionChannelForm({ defaultValues: item, onSuccess });
